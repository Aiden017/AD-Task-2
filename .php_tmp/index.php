<?php
    ...
    // Function to display a character card (similar to the Pokémon box function)
    function display_character($character) {
        ...
        echo '<a href="page/' . strtolower($character["name"]) . '.php" class="character-button">View ' . $character["name"] . "'s Page</a>";
        echo '</div>';
        echo '</div>';
        echo '<hr>';
    }
